...
# m <- lm(Happiness.Score ~ I(log(vvp_pps_na_dyshy.xls) + I(bezrabotiza.xls^(1/2)) + nalogi.xls + 
#                           nakoplenia_ludei.xls + rashodi_na_med.xls + chislo_ubistv.xls + 
#                           inflazia.xls + procent_tryd_naselenia.xls + 
#                           trati_na_obraz.xls + rogdaemost.xls + patenti.csv + 
#                           voennie_trati.xls ), data=dd)

m <- lm(Happiness.Score ~ I(log(vvp_pps_na_dyshy.xls)) + I(bezrabotiza.xls^(1/2)) + nalogi.xls + 
                              rashodi_na_med.xls + chislo_ubistv.xls + 
                              inflazia.xls + 
                              trati_na_obraz.xls , data=dd)
summary(m)
